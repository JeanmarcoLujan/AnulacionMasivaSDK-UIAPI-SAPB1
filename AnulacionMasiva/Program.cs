...
namespace AnulacionMasiva
{
    class Program
    {
        static void Main(string[] args)
        {
            Conexion.Conexion_SBO oConexion = new AnulacionMasiva.Conexion.Conexion_SBO();
            ...
            if ((oConexion != null) && (Conexion.Conexion_SBO.m_oCompany.Connected))
            {
               ...
               // Comunes.EstructuraDatos oEstructuraDatos = new Comunes.EstructuraDatos();
                Comunes.Eventos_SBO oEventos = new AnulacionMasiva.Comunes.Eventos_SBO();
